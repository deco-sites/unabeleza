      ...
      >
        ...
        <div class="col-start-1 col-span-1 row-start-1 row-span-1 z-10 self-center p-2 relative bottom-[15%]">
          <Slider.PrevButton class={clx(
            ...
            "disabled:invisible mobile:w-8 mobile:h-8"
            )}>
            {
              device === "desktop"
                ? (<Icon id="chevron-right" class="rotate-180" width={12} height={22} />)
                : (<Icon id="chevron-right-mobile" class="rotate-180" width={8} height={16} />)
            }
          </Slider.PrevButton>
        </div>
        ...
        <div class="col-start-3 col-span-1 row-start-1 row-span-1 z-10 self-center p-2 relative bottom-[15%]">
          <Slider.NextButton class={clx(
            ...
            {
              device === "desktop"
                ? (<Icon id="chevron-right" width={12} height={22} />)
                : (<Icon id="chevron-right-mobile" width={8} height={16} />)
            }
          </Slider.NextButton>
        </div>
