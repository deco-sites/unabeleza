...
function WishlistGallery(props: SectionProps<typeof loader>) {
    ...
    return (<div class="px-[min(4.16vw,63.89px)] mx-auto max-w-[96rem] mt-16 mb-16">
      <div class="mb-3">
        <h1 class="leading-8 lg:leading-10 font-bold text-xl lg:text-3xl text-center">
          Meus Favoritos
        </h1>
      </div>
      <div class={"grid items-center grid-cols-[repeat(auto-fit,minmax(340px,1fr))] mobile:grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-x-2 gap-y-16 "}>
