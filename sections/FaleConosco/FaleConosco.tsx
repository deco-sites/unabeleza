      ...
      <form className="max-w-[750px] w-full">
        <div className="flex items-center gap-[20px] mobile:flex-col mb-[24px]">
          ...
          <div className="flex flex-col justify-start w-1/2">
            ...
            <input className="border border-[#E7E7E7] rounded-[5px] pl-[20px] placeholder:font-[Montserrat] placeholder:text-[#999999] placeholder:font-normal placeholder:text-[14px] h-[41px] focus:outline-none  focus:border-[#A3E3FF]" type="email" placeholder="Digite seu e-mail" required/>
          </div>
        </div>
        <div className="w-full mb-[24px]">
          <label className="font-[Montserrat] font-bold text-[14px] leading-[21px] mb-[10px]">Assunto</label>
          <input className="w-full border border-[#E7E7E7] rounded-[5px] pl-[20px] placeholder:font-[Montserrat] placeholder:text-[#999999] placeholder:font-normal placeholder:text-[14px] h-[41px] focus:outline-none focus:border-[#A3E3FF]" type="text" placeholder="Digite o assunto" required/>
        </div>
        <div className="flex flex-col justify-start">
          <label className="font-[Montserrat] font-bold text-[14px] leading-[21px] mb-[10px]">Mensagem</label>
          <textarea placeholder="Digite sua mensagem" wrap="virtual" className="h-[222px] w-full border border-[#E7E7E7] rounded-[5px] pl-[20px] pt-[10px] placeholder:font-[Montserrat] placeholder:text-[#999999] placeholder:font-normal placeholder:text-[14px] focus:outline-none focus:border-[#A3E3FF]" required/>
        </div>
        <div className="flex justify-end mt-[24px]">
          <button className="py-[12px] px-[40px] border-[2px] border-[#8F2AED] rounded-[5px] text-[#8F2AED] font-[Montserrat] font-bold text-[14px] leading-[21px] hover:bg-[#BD87ED] hover:text-black hover:border-[#BD87ED]">ENVIAR</button>
        </div>
      </form>
    </div>
  );
